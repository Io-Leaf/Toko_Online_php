    ...
    <?php
            ...
            ?>
                ...
                <form action="proses_update_produk.php" method="post">
                    <input type="hidden" name="id_produk" value="<?=$dt_produk['id_produk']?>"><br>
                        nama produk :
                    <input type="text" name="nama_produk" value="<?=$dt_produk['nama_produk']?>" class="form-control"><br>
                        deskripsi :
                        <input type="text" name="deskripsi" value="<?=$dt_produk['deskripsi']?>" class="form-control"><br>
                        harga :
                    <input type="number" name="harga" value="<?=$dt_produk['harga']?>" class="form-control"><br>
                        foto produk :
                    <input type="file" name="foto_produk" value="<?=$dt_produk['foto_produk']?>"><br><br>
                    <input type="submit" name="simpan" value="Ubah Produk" class="btn btn-primary"><br><br>
