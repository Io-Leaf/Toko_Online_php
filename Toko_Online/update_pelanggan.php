    ...
    <?php
            ...
            ?>
                ...
                <form action="proses_update_pelanggan.php" method="post">
                    <input type="hidden" name="id_pelanggan" value="<?=$dt_pelanggan['id_pelanggan']?>"><br>
                        nama pelanggan :
                    <input type="text" name="nama" value="<?=$dt_pelanggan['nama']?>" class="form-control"><br>
                        alamat :
                    <input type="text" name="alamat" value="<?=$dt_pelanggan['alamat']?>" class="form-control"><br>
                        telpon :
                    <input type="number" name="telpon" value="<?=$dt_pelanggan['telp']?>" class="form-control"><br><br>
